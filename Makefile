...
smatool: smatool.o repost.o sma_mysql.o almanac.o sb_commands.o sma_struct.h
	gcc smatool.o repost.o sma_mysql.o almanac.o sb_commands.o -O2 -fstack-protector-all -Wall $(C_FLAGS_$(ARCH)) -lxml2 -lmysqlclient -lbluetooth -lcurl -lm -o smatool 
